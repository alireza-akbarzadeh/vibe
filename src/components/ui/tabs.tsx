	...
	return (
		<TabsPrimitive.Trigger
			...
			className={cn(
				...
				"data-active:bg-[#0a0a0a] dark:data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/30 data-active:text-foreground",
...
function TabsContent({
	...
	return (
		<TabsPrimitive.Content
			...
			className={cn("text-sm flex-1 outline-none size-full", className)}
			{...props}
		/>
	);
}
