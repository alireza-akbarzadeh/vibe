        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    role="combobox"
                    className={cn(
                        "min-h-9 h-auto w-full justify-between px-3 py-2 text-base md:text-sm rounded-md border transition-all shadow-xs",
                ...
                >
                    <div className="flex items-center gap-2 flex-wrap flex-1 min-h-7">
                        {Icon && (
            ...
            >
                <Command className="bg-transparent font-sans w-full border-none">
                    ...
                    <CommandList className="max-h-75 overflow-y-auto scrollbar-none">
