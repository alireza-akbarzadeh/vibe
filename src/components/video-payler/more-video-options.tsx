    ...
    return (
        <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end" side="top" className="w-48">
                ...
                {/* Fit to Screen */}
                <DropdownMenuItem onClick={() => { if (videoRef.current) videoRef.current.style.objectFit = 'contain'; }}>
                    <Frame className="mr-2 h-4 w-4" />
                    <span>Fit to Screen</span>
                </DropdownMenuItem>

                {/* Crop to Fill */}
                <DropdownMenuItem onClick={() => { if (videoRef.current) videoRef.current.style.objectFit = 'cover'; }}>
