...
const SERIES_DATA = [
    {
        season: 1,
        episodes: [
            { id: 1, title: "The Beginning", duration: "45m", thumb: "https://images.unsplash.com/photo-1618172193622-ae2d025f4128?w=200&h=120&fit=crop", progress: 100 },
            { id: 2, title: "The Dark Knight", duration: "42m", thumb: "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?w=200&h=120&fit=crop", progress: 40 },
            { id: 3, title: "Into the Abyss", duration: "50m", thumb: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=200&h=120&fit=crop", progress: 0 },
        ],
    }
]
            ...
            >
                <SheetHeader className="p-6 border-b border-zinc-800 mt-10">
                    <div className="flex items-center justify-between">
                        <SheetTitle className="text-white text-xl font-bold">Episodes</SheetTitle>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 mb-1">
                                        <span className="text-xs font-bold text-purple-400">EPISODE {ep.id}</span>
                                        {ep.progress === 100 && <CheckCircle2 className="size-3 text-emerald-500" />}
                                    </div>
