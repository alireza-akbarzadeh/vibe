...
import { PLANS, type PlanType } from "@/domains/plans/plans.constants";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-28 pb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-20">
            {plans.map((plan, idx) => {
              ...
              const isDisabled = loadingSlug !== null && loadingSlug !== plan.slug;
...
const COMPARE_FEATURES = [
  { name: "Music Streaming", free: "Limited", premium: "Unlimited", family: "Unlimited" },
  { name: "Movies & Shows", free: "Ad-supported", premium: "Ad-free", family: "Ad-free" },
  { name: "Video Quality", free: "SD", premium: "Full HD", family: "4K Ultra HD" },
    ...
    >
      ...
      <div className="rounded-xl border border-white/10 bg-white/3 backdrop-blur-xl overflow-hidden">
        ...
        <div className="grid grid-cols-4 gap-4 p-4 border-b border-white/10 bg-white/3">
          ...
          <div className="text-sm font-semibold text-gray-300 text-center">Free</div>
          <div className="text-sm font-semibold text-purple-300 text-center">Premium</div>
          <div className="text-sm font-semibold text-cyan-300 text-center">Family</div>
        </div>
      ...
      {COMPARE_FEATURES.length > 5 && (
        <div className="flex justify-center mt-4">
          ...
          >
            {expanded ? "Show less" : `Show all ${COMPARE_FEATURES.length} features`}
            <ChevronDown
              className={cn(
