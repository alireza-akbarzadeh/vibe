...
import { musicStore, togglePlay, toggleSidebar, updateCurrentTime } from '@/domains/music/music.store'
    ...
    return (
        <div className="h-screen bg-black flex flex-col overflow-hidden">
            <div className="flex-1 flex overflow-hidden relative">
                ...
                {/* 3. Main Content Area */}
                <main className={`flex-1 overflow-y-auto relative bg-[#0a0a0a] transition-all duration-300 ${isSidebarCollapsed ? 'pl-12' : ''}`}>
                    <Outlet />
                </main>
            </div>
            {currentSong && (
