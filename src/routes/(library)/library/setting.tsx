			...
			<div className="max-w-[1600px] mx-auto px-6 py-12 md:px-20 md:py-24">
				...
				<header className="mb-20 md:mb-32">
					...
					<Typography.H1 className="text-8xl md:text-[140px] font-black tracking-[-0.06em] leading-[0.75] uppercase italic">
						Config
						<span className="text-muted-foreground/20 not-italic">ure</span>
					</Typography.H1>
				</header>
					...
					<main className="max-w-3xl">
									...
									<AlertDialog>
										...
										<AlertDialogContent className="bg-zinc-950 border-white/10 max-w-md">
											<AlertDialogHeader>
												...
												<AlertDialogDescription>
													This permanently deletes your account, subscription,
													favorites, watchlist, and all associated data. This
													cannot be undone.
												</AlertDialogDescription>
											</AlertDialogHeader>
											<AlertDialogFooter>
						...
						>
							<section className="space-y-12">
								...
								<form onSubmit={handlePasswordChange} className="space-y-16">
									<div className="grid gap-10">
										<InputGroup
											...
											<>
												{subscription?.amount && (
													<p className="text-xs font-bold leading-relaxed">
														...
														{subscription.interval} &middot; Next billing{" "}
												...
												<Button
													...
													asChild
												>
													<Link to="/library/subscription">Manage Billing</Link>
												</Button>
											</>
										)}
										{isFree && (
