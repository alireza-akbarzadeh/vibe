        ...
        <Drawer>
            ...
            <DrawerContent className="bg-[#0F0F0F] border-t border-white/10 text-white pb-10 outline-none">
                ...
                <DrawerHeader className="px-6">
                    <DrawerTitle className="text-left text-base font-bold">Share to</DrawerTitle>
                </DrawerHeader>

                <div className="flex gap-6 overflow-x-auto px-6 py-4 scrollbar-hide">
                    <ShareOption icon={<MessageCircle className="text-green-500" />} label="WhatsApp" />
                    <ShareOption icon={<Twitter className="text-blue-400" />} label="Twitter" />
                    <ShareOption icon={<Send className="text-sky-500" />} label="Telegram" />

                    {/* Copy Link closes the drawer automatically via DrawerClose */}
                    <DrawerClose asChild>
                        <ShareOption
                            icon={<div className="bg-white/10 p-3 rounded-full"><Link2 /></div>}
                            label="Copy Link"
