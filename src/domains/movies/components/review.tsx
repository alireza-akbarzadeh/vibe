        ...
        >
            <Card className="bg-white/3 backdrop-blur-xl border border-white/10 p-6 hover:bg-white/5 hover:border-white/20 transition-all">
                ...
                <div className="flex items-center gap-6 mt-4 pt-4 border-t border-white/5">
                    <Button variant="text" className="flex items-center gap-2 text-gray-400 hover:text-purple-400 transition-colors">
                    ...
                    <Button variant="text" className="flex items-center gap-2 text-gray-400 hover:text-red-400 transition-colors ml-auto">
