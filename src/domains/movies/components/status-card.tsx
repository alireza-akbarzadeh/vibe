...
export function StatsCard(props: StatusCardProps) {
    ...
    return (
        ...
        >
            <Card
                className="relative overflow-hidden bg-white/3 backdrop-blur-xl border border-white/10 p-6 hover:bg-white/5 hover:border-white/20 transition-all duration-300 group">
                <div
