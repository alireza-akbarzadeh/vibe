        ...
        <section className="relative py-20 bg-linear-to-b from-[#0d0d0d] to-[#0a0a0a]">
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <MovieImages images={filterImage(activeTab)} openLightbox={openLightbox}/>
                </motion.div>
            </div>
            <LightBox src={images[currentImage].url} imageLength={images.length} currentImage={currentImage}
                      navigate={navigate} setLightboxOpen={setLightboxOpen} lightboxOpen={lightboxOpen}/>
        </section>
    );
}
