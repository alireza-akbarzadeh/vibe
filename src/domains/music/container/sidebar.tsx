    ...
    return (
        <div className="flex flex-col h-full gap-2 p-2 select-none w-full bg-black">
            ...
            <nav className="bg-[#121212] rounded-xl p-2 space-y-1">
                <NavItem icon={Home} label="Home" to="/music" isCollapsed={isSidebarCollapsed} />
                <NavItem icon={Search} label="Search" to="/music/search" isCollapsed={isSidebarCollapsed} />
            </nav>
            ...
            <div className="bg-[#121212] rounded-xl flex-1 flex flex-col overflow-hidden">
                <header className="pt-3 px-4 shadow-[0_4px_12px_rgba(0,0,0,0.5)] z-10">
                    ...
                    {/* Library Header Row */}
                    <div className={`flex items-center text-gray-400 mb-2 ${isSidebarCollapsed ? 'justify-center' : 'justify-between'
                        }`}>
                        <button
                            type="button"
                    ...
                    {!isSidebarCollapsed && (
                        ...
                        >
                            ...
                            <div className="pb-2 flex items-center justify-between text-gray-400 min-h-10">
                                ...
                                {!isSearching && (
                                    <button
                                        type='button' className="flex items-center gap-1.5 text-xs font-medium hover:text-white transition-colors group">
                                        <span>Recents</span>
