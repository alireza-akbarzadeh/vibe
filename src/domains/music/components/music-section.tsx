...
import { ChevronLeft, ChevronRight, Heart, MoreVertical, Play, Sparkles } from "lucide-react";
...
export function MusicSection({ title, items, variant = "square" }: MusicSectionProps) {
        ...
        <section className="mb-14 relative group/section">
            ...
            >
                {items.map((item, index) => {
                    const isCurrentlyLiked = item.isLiked || library.some(l => l.id === item.id.toString() && l.isLiked);
                    return (
                        <motion.div
                            key={item.id}
                        ...
                        >
                            ...
                            <div className="relative mb-4">
                                ...
                                {item.isTrending && (
                                    <div className="absolute top-2 left-2 px-2 py-1 bg-purple-600/90 backdrop-blur-md rounded-md flex items-center gap-1 border border-white/20">
                                        ...
                                        <span className="text-[8px] font-black uppercase text-white">Hot</span>
                                    </div>
                                )}
                                    ...
                                    <button
                                        ...
                                        <Heart
                                            className={cn(
                                                ...
                                                isCurrentlyLiked ? "fill-pink-500 text-pink-500" : "text-white"
                                            )}
                                        />
                                    </button>
                                    <button
                            ...
                            {/* TEXT CONTENT */}
                            <div className={cn("space-y-1.5 px-1", variant === "circle" && "text-center")}>
