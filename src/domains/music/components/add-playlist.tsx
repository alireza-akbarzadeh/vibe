...
export function AddToPlaylistModal({ isOpen, onClose, playlists, onAddToPlaylist, onCreateNew }: AddToPlaylistModalProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
              ...
              {playlists.map((playlist) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm text-gray-400 truncate">{playlist.subtitle}</div>
                  </div>
                </button>
              ))}
            </div>
