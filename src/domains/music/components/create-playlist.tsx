                    ...
                    >
                        <div className="bg-zinc-900 rounded-xl border border-white/10 p-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    <label htmlFor={playlistNameId} className="text-sm font-medium text-gray-300 mb-2 block">
                                        Playlist Name
                                    </label>
                                    <Input
                                        id={playlistNameId}
                                ...
                                <div>
                                    <label htmlFor={descriptionId} className="text-sm font-medium text-gray-300 mb-2 block">
