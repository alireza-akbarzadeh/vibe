			...
			<div className="relative z-10 max-w-7xl mx-auto px-6">
				...
				<div className="relative">
					...
					>
						{/* TV/Monitor mockup */}
						<div className="relative">
							<div className="aspect-video rounded-3xl bg-gradient-to-br from-gray-800 to-gray-900 p-2 shadow-2xl shadow-purple-500/10">
							...
							{/* Stand */}
							<div className="mx-auto w-32 h-6 bg-gradient-to-b from-gray-700 to-gray-800 rounded-b-lg" />
						...
						>
							<div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-1 shadow-xl">
				...
				>
					{devices.map((device, index) => (
						<motion.div
							...
							className="group text-center p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] hover:border-white/10 transition-all duration-300"
						>
							<div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] mb-4 group-hover:from-purple-500/20 group-hover:to-pink-500/20 transition-all duration-300">
								<device.icon className="w-8 h-8 text-white/60 group-hover:text-white transition-colors" />
							</div>
							<h3 className="text-white font-semibold mb-1">{device.label}</h3>
							<p className="text-gray-500 text-sm">{device.description}</p>
						</motion.div>
					))}
				</motion.div>
			</div>
