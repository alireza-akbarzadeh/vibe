                ...
                <div className="relative h-full rounded-xl md:rounded-2xl overflow-hidden bg-black">
                    ...
                    <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/10 to-black/30">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-3 md:p-5">
                            ...
                            <MockProgress progress="65%" color="bg-linear-to-r from-purple-500 to-pink-500" />
                ...
                <div className="relative max-w-5xl mx-auto">
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ boxShadow: ["0 0 0 0 rgba(168,85,247,0)", "0 0 0 8px rgba(168,85,247,0.08)", "0 0 0 0 rgba(168,85,247,0)"] }}
