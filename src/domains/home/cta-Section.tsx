...
import { ArrowRight, Check, Film, Music, Sparkles } from "lucide-react";
			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
				...
				>
					...
					<Typography.P className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
						...
						free trial today and discover a new era of entertainment.
					</Typography.P>
					...
					<div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
						...
						<Button
							onClick={() => navigate({ to: "/plans", resetScroll: true })}
							variant="ghost"
							size="lg"
