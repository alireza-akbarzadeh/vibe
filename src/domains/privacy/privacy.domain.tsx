                            ...
                            <nav className="space-y-1">
                                {sections.map((section) => (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-left transition-all ${activeSection === section.id
                    ...
                    <main className="lg:col-span-3 space-y-16">
                        ...
                        <section id="introduction">
                            ...
                            <div className="prose prose-invert max-w-none">
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    Welcome to Vibe. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we handle your personal data when you visit our platform and use our services.
                                </p>
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    This policy applies to all users of Vibe, including free and premium subscribers, and covers both our website and mobile applications.
                                </p>
                                <div className="mt-6 p-6 bg-purple-900/20 border border-purple-500/30 rounded-xl">
                                    <p className="text-gray-300 leading-relaxed">
                                        <strong className="text-white">Key Point:</strong> We will never sell your personal information to third parties. Your data is used solely to provide and improve our services.
                                    </p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="usage">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        { title: 'Service Delivery', desc: 'To provide, maintain, and improve our streaming services' },
                                        { title: 'Personalization', desc: 'To recommend content based on your preferences and history' },
                                        { title: 'Communication', desc: 'To send service updates, newsletters, and promotional content' },
                                        { title: 'Payment Processing', desc: 'To process subscriptions and manage billing' },
                                        { title: 'Security', desc: 'To detect fraud and ensure platform security' },
                                        { title: 'Analytics', desc: 'To understand usage patterns and improve user experience' }
                                    ].map((item, index) => (
                                ...
                                <div className="space-y-4">
                                    <div className="p-6 bg-white/5 border border-white/10 rounded-xl">
                                        ...
                                        <p className="text-gray-400">
                                            We share data with trusted third-party service providers who help us operate our platform, including payment processors, cloud hosting providers, and analytics services.
                                        </p>
                                    </div>
                        ...
                        <section id="security">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        { icon: Lock, title: 'Encryption', desc: 'AES-256 encryption for data at rest and in transit' },
                                        { icon: Shield, title: 'Secure Servers', desc: 'PCI-DSS compliant infrastructure and data centers' },
                                        { icon: Eye, title: 'Access Controls', desc: 'Strict access controls and authentication protocols' },
                                        { icon: Database, title: 'Regular Audits', desc: 'Periodic security audits and vulnerability assessments' }
                                    ].map((item, index) => (
                                        <div key={index} className="p-5 bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-xl">
                        ...
                        {/* Cookies & Tracking */}
                        <section id="cookies">
                            <h2 className="text-3xl font-bold text-white mb-6">Cookies & Tracking Technologies</h2>
                            <div className="space-y-4">
                                <p className="text-gray-300 leading-relaxed">
                                ...
                                <div className="space-y-3">
                                    {[
                                        { type: 'Essential Cookies', purpose: 'Required for platform functionality and security' },
                                        { type: 'Performance Cookies', purpose: 'Help us understand how users interact with our service' },
                                        { type: 'Functional Cookies', purpose: 'Remember your preferences and settings' },
                                        { type: 'Targeting Cookies', purpose: 'Deliver personalized content and advertisements' }
                                    ].map((cookie, index) => (
                                        <div key={index} className="p-4 bg-white/5 border border-white/10 rounded-lg">
                                            <div className="flex items-start gap-3">
                                                <Cookie className="w-5 h-5 text-purple-500 flex-shrink-0 mt-0.5" />
                                                <div>
                                                    <h5 className="text-white font-semibold">{cookie.type}</h5>
                                                    <p className="text-gray-400 text-sm">{cookie.purpose}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        { right: 'Restriction', desc: 'Request restriction of processing your data' }
                                    ].map((item, index) => (
                                        <div key={index} className="flex items-start gap-4 p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors">
                                            ...
                                            <div>
                                                <h5 className="text-white font-semibold mb-1">{item.right}</h5>
                                                <p className="text-gray-400 text-sm">{item.desc}</p>
                                            </div>
                                        </div>
                                    ))}
                                ...
                                <div className="mt-6 p-6 bg-blue-900/20 border border-blue-500/30 rounded-xl">
                                    <p className="text-gray-300">
                                        ...
                                        <a href="mailto:privacy@vibe.com" className="text-blue-400 hover:underline">
                                            privacy@vibe.com
                                        </a>
                                    </p>
                                </div>
