...
const activities = [
    { id: 1, user: "Alex Rivera", action: "Upgraded to", target: "Premium", time: "2m ago", icon: "🚀" },
    { id: 2, user: "Jordan Smith", action: "Verified email", target: "", time: "15m ago", icon: "✅" },
    { id: 3, user: "Casey Knight", action: "Logged in from", target: "Berlin, DE", time: "1h ago", icon: "🌐" },
];
            ...
            <div className="space-y-3">
                <AnimatePresence mode="popLayout">
                    {activities.map((item, index) => (
                        ...
                        >
                            {/* Icon Container with subtle pop animation */}
                            <motion.div
