...
import {
    Briefcase, Calendar, ChevronRight, Clock, Code, Coffee, DollarSign,
    Filter, Gift,
    Globe, GraduationCap,
    Heart,
    Home, MapPin, Music, Rocket, Search,
...
export function CareersDomain() {
    ...
    const jobs = [
        {
            ...
            location: 'Remote',
            type: 'Full-time',
            description: 'Build scalable systems that power millions of streams daily',
    ...
    const values = [
        {
            icon: Heart,
            title: 'Music First',
            description: 'We are passionate about music and believe in its power to connect people'
        },
        {
            icon: Zap,
            title: 'Move Fast',
            description: 'We iterate quickly, learn from failures, and ship products users love'
        },
        {
            icon: Users,
            title: 'Collaborate',
            description: 'We work together across teams to create amazing experiences'
        },
        {
            icon: Globe,
            title: 'Think Global',
            description: 'We build for a diverse, worldwide community of music lovers'
        }
    ];

    const benefits = [
        { icon: DollarSign, title: 'Competitive Salary', description: 'Market-leading compensation' },
        { icon: Heart, title: 'Health Insurance', description: 'Medical, dental, and vision' },
        { icon: Home, title: 'Remote Work', description: 'Flexible work arrangements' },
        { icon: Calendar, title: 'Unlimited PTO', description: 'Take time when you need it' },
        { icon: GraduationCap, title: 'Learning Budget', description: '$2,000 annual education fund' },
        { icon: Gift, title: 'Premium Account', description: 'Free Vibe Premium for you and family' },
        { icon: Coffee, title: 'Wellness', description: 'Gym memberships and mental health support' },
        { icon: Rocket, title: 'Equity', description: 'Own a piece of the company' }
    ];
    ...
    return (
        <div className="min-h-screen bg-black">
                ...
                <div className="relative max-w-5xl mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
                            Help us build the future of music and entertainment. Work with talented people who love what they do.
                        </p>

                        <div className="flex flex-wrap items-center justify-center gap-4">
                            <Button
                                size="lg"
                                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white px-8 rounded-full"
            ...
            {/* Benefits */}
            <section className="py-24 bg-gradient-to-b from-purple-900/10 to-black">
                <div className="max-w-6xl mx-auto px-6">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        ...
                        <div className="flex flex-wrap gap-2">
                            {departments.map((dept) => (
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${selectedDepartment === dept.id
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            {locations.map((loc) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${selectedLocation === loc.id
