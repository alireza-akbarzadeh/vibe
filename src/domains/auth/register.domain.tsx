        ...
        >
            <form.Root className="space-y-5">
                ...
                <div className="p-4 rounded-xl bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-purple-500/20">
                    <p className="text-white font-medium text-sm mb-3">What you'll get:</p>
                    ...
                    {(field) => (
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <Label htmlFor={agreeToTerms} className="text-sm text-gray-400 flex gap-1 items-center">
                                    I agree to the <TermsOfServiceDialog /> and <PrivacyPolicyDialog />
                                </Label>
                            </div>
                            {field.state.meta.errors?.length > 0 && field.state.meta.isTouched && (
                                <p className="text-xs text-red-400 mt-1">{field.state.meta.errors[0].message}</p>
                            )}
                        </div>
                    )}
                </form.Field>
