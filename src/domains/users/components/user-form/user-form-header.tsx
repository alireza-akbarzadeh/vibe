            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div className={cn(
                            ...
                            isEditMode ? "bg-amber-500/10 text-amber-600" : "bg-primary/10 text-primary"
                        )}>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-xs font-medium text-muted-foreground">
                                    {isEditMode ? "Synchronizing system-wide permissions" : "Registering new entity node"}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-4 bg-muted/30 p-2 rounded-2xl border border-border/40 backdrop-blur-sm">
                    <div className="px-4 border-r border-border/60">
                        <p className="text-[8px] font-black uppercase tracking-widest text-muted-foreground mb-0.5">Status</p>
                        <div className="flex items-center gap-1.5">
                            <div className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
                            <span className="text-[10px] font-bold uppercase">System Live</span>
                        </div>
                    </div>
                    <div className="px-4">
                        <p className="text-[8px] font-black uppercase tracking-widest text-muted-foreground mb-0.5">Server Time</p>
