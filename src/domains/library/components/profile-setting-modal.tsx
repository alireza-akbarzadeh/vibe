			...
			<div className="p-4 md:p-6 max-h-[85vh] overflow-y-auto custom-scrollbar max-w-full w-full flex-1">
										...
										<div className="flex flex-col sm:flex-row items-center gap-6 p-6 rounded-2xl bg-white/5 border border-white/5">
											...
											<div className="space-y-1 text-center sm:text-left">
												...
												<Button
													size="sm"
													variant="link"
													className="text-[10px] p-0 h-auto uppercase tracking-widest text-muted-foreground hover:text-primary"
												>
													Update Avatar
												</Button>
											</div>
										...
										<div className="space-y-4">
											<div className="space-y-2">
												...
												<Input
													...
													className="bg-black/40 border-white/10 rounded-xl h-12 focus:ring-1 focus:ring-primary/50"
												/>
											</div>
											<div className="space-y-2">
												<Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/50 ml-1">
				...
				<div className="mt-8 pt-6 border-t border-white/5 flex flex-col sm:flex-row gap-4 items-center justify-between">
					...
					<div className="flex items-center gap-3 w-full sm:w-auto">
						<Button
							variant="ghost"
							className="flex-1 sm:flex-none text-[10px] font-black uppercase"
						>
							Discard
						</Button>
